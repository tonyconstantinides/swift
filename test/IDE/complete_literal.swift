...
// LITERAL4-DAG:     Decl[InstanceMethod]/CurrNominal:   withCString({#(UnsafePointer<Int8>) throws -> Result##(UnsafePointer<Int8>) throws -> Result#})[' rethrows'][#Result#]; name=withCString((UnsafePointer<Int8>) throws -> Result) rethrows{{$}}
